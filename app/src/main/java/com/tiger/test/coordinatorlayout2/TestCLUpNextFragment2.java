...
public class TestCLUpNextFragment2 extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        layoutView = inflater.inflate(R.layout.fragment_up_next2, container, false);
        return layoutView;
    }
