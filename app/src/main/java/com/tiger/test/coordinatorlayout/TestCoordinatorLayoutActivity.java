...
import com.tiger.test.databinding.ActivityTestCoordinatorLayoutBinding;

public class TestCoordinatorLayoutActivity extends FragmentActivity {

    private TestCLAdapter clAdapter = null;
    private ActivityTestCoordinatorLayoutBinding mBinding = null;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_test_coordinator_layout);

        initViewPager();
    }

    private void initViewPager() {
        clAdapter = new TestCLAdapter(getSupportFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
