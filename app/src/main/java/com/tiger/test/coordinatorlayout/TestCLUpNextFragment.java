...
public class TestCLUpNextFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        layoutView = inflater.inflate(R.layout.fragment_up_next, container, false);
        return layoutView;
    }
