...
public class StickyScrollView extends NestedScrollView {
    ...
    private void startStickingView(View viewThatShouldStick) {
        ...
        LogUtil.logd("startStickingView.");
        if (onStickingViewStateListener != null) {
            onStickingViewStateListener.onStartStickingView();
        }
    }
    ...
    private void stopStickingCurrentlyStickingView() {
        ...
        LogUtil.logd("stopStickingCurrentlyStickingView.");
        if (onStickingViewStateListener != null) {
            onStickingViewStateListener.onStopStickingView();
        }
    }

    private OnStickingViewStateListener onStickingViewStateListener;

    public void setOnStickingViewStateListener(OnStickingViewStateListener listener) {
        this.onStickingViewStateListener = listener;
    }

    public interface OnStickingViewStateListener {
        void onStartStickingView();

        void onStopStickingView();
    }
