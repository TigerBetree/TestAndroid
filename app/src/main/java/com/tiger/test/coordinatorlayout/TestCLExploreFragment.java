...
public class TestCLExploreFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        layoutView = inflater.inflate(R.layout.fragment_explore, container, false);
        return layoutView;
    }
