...
import com.tiger.test.BuildConfig;
 ...
 */
public class GalleryLayoutManager2 extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public GalleryLayoutManager2(int orientation) {
    ...
    public interface ItemTransformer {
         ...
         */
        void transformItem(GalleryLayoutManager2 layoutManager, View item, float fraction);
    }
